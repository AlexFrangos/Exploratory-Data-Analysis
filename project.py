...
def menu(admissions_data,admissions_data_old):
	    choice = input("""
                      ...
                      E: Run the topScorersWithChanceOfAdmit function. You can call the function with any column from the dataset.
	    ...
	    if choice == "A" or choice == "a":
	    	...
	    	column = input("Enter any valid column from the dataset: ")
	    	
	    	topScoresWithChanceOfAdmit(admissions_data,column)
...
while True:
	time.sleep(1)
	if menu(admissions_data,admissions_data_old) == "exit":
		break
	else:
